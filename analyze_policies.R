...
Fn_Analyze_Policies <- function(raw_policies_file, output_policies_file, 
                              output_policies_aggregated_file) {  
  ...
  out_policies <- subset(out_policies, state %in% c(state.name, "District Columbia"))
